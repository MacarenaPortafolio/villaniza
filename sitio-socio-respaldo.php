...
<div class="contenedor-grande sesion">
  ...
  <tr>
    ...
    <div class="contenido-azul info-gastos">
      ...
      <?php 
		     ...
		     if($MesActual==1){
                 ...
                 $query = "SELECT ultimo_pago , saldo , descripcion FROM cuentas as cu left join usuarios as us on id_usuario = us.id left join mes as mes on id_mes = mes.id where id_mes = ".$Mes." and ano = ".$Ano." and id_usuario = ".$id_usuario."";
			     $rs = $db->query($query);                 
                 if(count($rs)<1){
                        if($Mes==1){
	      ...
	      ?>
	<table>
			<p>ESTADO DE CUENTA DE <?php echo strtoupper($NMes)?> DEL <?php echo $Ano?></p>
			<tr class="thead">
    ...
    <div class="dudas-consultas">
      ...
      <div class="formulario-socios">
        <form action="enviar-contador.php" method="post" >
          <div class="form-izquierdo">
            <label>NOMBRE</label>
            <input name="nombre" type="text" value="<?php echo $row_consulta1['nombre']; ?> <?php echo $row_consulta1['apellido']; ?>">
            <label>E-MAIL</label>
            <input name="email" type="text" value="<?php echo $row_consulta1['email']; ?>">
            <label>ASUNTO</label>
          ...
          <div class="datos">
            ...
            <p class="email">carrasco.leonel@gmail.com</p>
          </div>
        </form>
      </div>
    </div>
  ...
  <footer>
    <ul>
      ...
      <li><a href="villaniza.php" title="Villa Niza">VILLA NIZA </a></li>
      <li><a href="proyectos.php" title="Proyectos">PROYECTOS</a></li>
      <li><a href="galeria.php" title="Galería">GALERÍA</a></li>
      <li class="ultimo-elemento"><a href="contacto.php"  title="Contacto">CONTACTO</a></li>
    </ul>
    <div class="datos-footer">
            	<p>Algarrobo,Sector El Litre, Villa Niza. Hijuela del Aserradero, lotes 3A y 3B.</p>
            	<p>info@villaniza.cl - 25521503</p>
