 ...
 <?php /*?><tr>
    ...
    <input type="hidden" id="email" name="email" value="<?php echo $row_consulta1['email']; ?>"/>
     ...
     <?php 
      ...
      <p>ESTADO DE CUENTA DE OCTUBRE DE 2015</p>
      ...
      <?php 
          ...
          <div class="formulario-contacto">
            ...
            <form action="sitio-administrador.php" method="post" enctype="multipart/form-data"> 
...
<br/>ASUNTO: <br/><input class="asunto" type='text' name='asunto' id='asunto' required />
<br/>
...
$sTexto = $sTexto."Asunto: ".$_POST['asunto']."\n";
