     ...
     <?php 
      ...
      <?php 
          ...
          <div class="formulario-contacto">
            ...
            <form action="sitio-administradorprueba.php" method="post" > 
            
<div class="contenedor-lista-usuarios">
	SELECCIONE USUARIO <br>
    <input name="todos" id="todos" type="checkbox" value="todos" class="check" onchange="Cambio()"/> Seleccionar todos los usuarios.
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {  
    $email=$_POST["checkbox-<?php echo $i; ?>"];
    $count = count($email);
    for ($i = 0; $i < $count; $i++) {
        echo $email[$i];
    }
...
$mensaje = "Este mensaje fue enviado por Villa Niza Macarena" . " \r\n";
$mensaje .= "Su e-mail es: " . $emailadmin . " \r\n";
